...
- **Page id:** 4048
- **Parent page id:** 2550
- **Magnus uri:** /api/TriumphTech/Magnus/GetTreeItems/websites/page/4048
- **Pulled:** 2026-08-28 from https://rock.tfh.org
...
| Main | Page Menu | Page Menu | 8825 | no — not HTML Content |
...
No `blocks/` folder: the only page-level block (8825) is a Page Menu and holds
no markup. Page attributes are all defaults (Hide Navigation No, Hide Header
No, Show TFH Logo No, Show Page Loader No).
